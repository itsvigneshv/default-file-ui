...
/* Modes: <html data-df-color-scale="compact|detailed"> (default: detailed) */

/* Default + detailed */
${block(":root, [data-df-color-scale=\"detailed\"]", detailedPairs)}

/* Compact */
${block("[data-df-color-scale=\"compact\"]", compactPairs)}
`
